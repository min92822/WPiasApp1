...
class SignUpPreActivity : RootActivity() {
    ...
    fun viewSetting(){
        ...
        // 약관보기 & 닫기
        btn_sign_up_pre_open_1.setOnClickListener { in_sign_up_pre_1.visibility = View.VISIBLE }
        btn_sign_up_pre_close_1.setOnClickListener { in_sign_up_pre_1.visibility = View.GONE }
        btn_sign_up_pre_open_2.setOnClickListener { in_sign_up_pre_2.visibility = View.VISIBLE }
    ...
    fun checkVal(){
        ...
        btn_sign_up_pre.setOnClickListener {
            if(chk_sign_up_pre_all.isChecked){
                startActivity(Intent(this@SignUpPreActivity, SignUpActivity::class.java).setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP))
            } else {
                notCheckedAlert()
            }
        }
    ...
    fun res(chkarr:ArrayList<CheckBox>):View.OnClickListener{
        return View.OnClickListener { chk_sign_up_pre_all.isChecked = chkarr[0].isChecked && chkarr[1].isChecked && chkarr[2].isChecked }
    }
